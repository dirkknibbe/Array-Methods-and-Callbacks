...
*/
// recieve an array as param this will be fifaData when you pass in the argument
//
function getFinals(array){
    const filteredArray = array.filter(item => item.Stage === 'Final');
...
// two params array and getFinals callback 
...
function getWinners(array, getFinalscb) {
    ...
    // use map
    // use conditionals
    // if hometeamgoasl is greater than away teeam goals 
    // else we want away team name
}
...
return string;
    ...
    // i would map over one array and grab each item and then i woulld use the index to grab the item in the other array
}
...
return (averageGoals / getFinalscb.length).toFixed(2);
   ...
   // i would use .reduce to add up all the goals of home and away team
